...
import hearme.locator.place.PlaceProvider;
import hearme.locator.place.PlacesList;
import hearme.locator.viewer.PlaceViewer;
...
public class GPSActivity extends Activity {
    ...
    protected void find() {
        ...
        if (location != null) {
            ...
            hearme.environment.Location locationInfo = placeProvider.getPlacesList(location.getLatitude(), location.getLongitude());
            PlacesList list = locationInfo.getPlacesList();

            Intent intent = new Intent(this, PlaceViewer.class);
